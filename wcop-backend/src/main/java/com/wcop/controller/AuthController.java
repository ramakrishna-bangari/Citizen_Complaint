...
public class AuthController {
    ...
    public ResponseEntity<LoginResponse> register(@Valid @RequestBody RegisterRequest request, HttpServletResponse response) {
        ...
        addAuthCookies(response, result.getAccessToken(), result.getRefreshToken());
        LoginResponse loginResponse = LoginResponse.builder().user(result.getUser()).build();
    ...
    public ResponseEntity<LoginResponse> verifyOtp(@Valid @RequestBody VerifyOtpRequest request, HttpServletResponse response) {
    ...
    // Updates the CURRENTLY LOGGED-IN user's own profile. Works for any authenticated role.
